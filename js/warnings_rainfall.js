...
dstr +=	"<li class='ui-li-static ui-body-inherit ui-first-child'><span>Issued Date:</span> " + vIssuedAt
+"<br><br><span>Valid until:  </span> 12:00 PM Today";
dstr +=	"</li> <li class='ui-li-static ui-body-inherit'> <span>Warning Number: </span>" + warningnum[x] + " </li> ";
